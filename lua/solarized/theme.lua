...
theme.loadSyntax = function ()
	...
	local syntax = {
		...
		Statement =					{ fg = solarized.text_light }, -- any statement
		...
		Define =					{ fg = solarized.text_light }, -- preprocessor #define
		...
		SpecialChar =				{ fg = solarized.text_light }, -- special character in a constant
		Tag =						{ fg = solarized.red }, -- you can use CTRL-] on this
		Delimiter =					{ fg = solarized.cyan }, -- character that needs attention like , or .
		SpecialComment =			{ fg = solarized.text_light }, -- special things inside a comment
	...
	if vim.g.solarized_italic_variables == true then
		syntax.Identifier =				{fg = solarized.text_light, bg = solarized.none, style = 'italic'}; -- any variable name
    else
		syntax.Identifier =				{fg = solarized.text_light}; -- any variable name
    end
...
theme.loadEditor = function ()
	...
	local editor = {
		...
		IncSearch =				{ fg = solarized.cyan, bg = solarized.bg, style = 'reverse' },
		...
		Search =				{ fg = solarized.cyan, bg = solarized.bg, style = 'reverse' },
		...
		CommandMode =			{ fg = solarized.text_light, bg = solarized.none, style = 'reverse' },
        ...
        -- Dashboard
        DashboardShortCut =                     { fg = solarized.text_light },
        DashboardHeader =                       { fg = solarized.text_light },
        DashboardCenter =                       { fg = solarized.text_light },
...
theme.loadTerminal = function ()
	...
	vim.g.terminal_color_8 = solarized.text_light
...
theme.loadTreeSitter = function ()
    ...
    local treesitter = {
        ...
        TSField =                   { fg = solarized.text_light}, -- For fields.
    ...
    if vim.g.solarized_italic_variables == true then
        treesitter.TSVariable =                { fg = solarized.text_light, style = 'italic' } -- Any variable name that does not have another highlight.
        treesitter.TSVariableBuiltin =         { fg = solarized.text_light, style = 'italic' } -- Variable names that are defined by the languages, like `this` or `self`.
    else
...
theme.loadPlugins = function()
    ...
    local plugins = {
        ...
        LspSagaSignatureHelpBorder =            { fg = solarized.text_light },
